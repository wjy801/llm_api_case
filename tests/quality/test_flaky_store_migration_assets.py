...
EXPECTED_RAW_HASHES = {
    ...
    "0004_probe_dispatch.sql": "753c8c9ab40a80f5772ad0fb3e1ce0f9a8d2fb43db32aa649116dd1a00ad416e",
}
EXPECTED_MIGRATION_CHECKSUMS = {
    ...
    4: "753c8c9ab40a80f5772ad0fb3e1ce0f9a8d2fb43db32aa649116dd1a00ad416e",
}
...
def test_flaky_migrations_keep_names_raw_bytes_and_normalized_checksums():
    ...
    assert tuple(item.version for item in migrations) == (1, 2, 3, 4)
