...
flowchart LR
    E[_extract_value]
    E --> J[json_path<br/>解析response.json]
    E --> H[header<br/>response.headers.get]
    E --> C[cookie<br/>response.cookies.get]
    E --> R[regex<br/>response.text或source_text]
```
### 6.2 JSONPath
...
sequenceDiagram
    ...
    participant F as test_context fixture
